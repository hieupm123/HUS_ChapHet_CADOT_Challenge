...
# --- Configuration ---
ORIGINAL_IMAGE_DIR = "../data/train_inpainted_cv2"
COCO_ANNOTATION_FILE = "../data/train_inpainted_cv2/_annotations_modified.coco.json"

OBJECT_SOURCE_DIRS = {
    "ship": "../data/outargument_color_variants/ship",
    "train": "../data/outargument_color_variants/train",
    "basketball field": "../data/out_data_with_new/basketball_field",
    "crosswalk": "../data/split_folder_all_classes/crosswalk",
    "football field": "../data/out_data_with_new/football_field",
    ...
    "roundabout": "../data/out_data_with_new/roundabout",
    "swimming pool": "../data/out_data_with_new/swimming_pool",
    "tennis court": "../data/out_data_with_new/tennis_court",
    "building": "../data/split_folder_all_classes/building",
    "small vehicle": "../data/split_folder_all_classes/small_vehicle"
}

OUTPUT_BASE_DIR = "../data/augmented_dataset_direct_paste_v5" 
OUTPUT_AUGMENTED_IMAGE_DIR = "../data/augmented_dataset_direct_paste_v5" 
