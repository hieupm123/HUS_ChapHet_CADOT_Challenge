...
CONFIGURATIONS = [
    {
        ...
        "images_info_json_path": "../../data/CADOT_Dataset/valid/_annotations.coco.json", # File JSON chứa danh sách ảnh cho cấu hình này
        "confidence_threshold": 0.02,
        "iou_threshold": 0.6,
        "image_target_size": 512,
        "output_directory": "../../data/evaluation_results/infer_yolov11_origin", # THƯ MỤC LƯU TRỮ KẾT QUẢ
    ...
    },
    {
        ...
        "images_info_json_path": "../../data/CADOT_Dataset/valid/_annotations.coco.json",
        "confidence_threshold": 0.02,
        "iou_threshold": 0.69,
        "image_target_size": 512,
        "output_directory": "../../data/evaluation_results/infer_yolov11_v3",
    ...
    },
    {
        ...
        "iou_threshold": 0.6,
        "image_target_size": 512,
        "output_directory": "../../data/evaluation_results/infer_yolov11_v5",
        "output_filename_prefix": "detections"
    },
    {
        ...
        "iou_threshold": 0.5,
        "image_target_size": 512,
        "output_directory": "../../data/evaluation_results/infer_yolov12_v3",
        "output_filename_prefix": "detections"
    },
    {
        ...
        "iou_threshold": 0.6,
        "image_target_size": 512,
        "output_directory": "../../data/evaluation_results/infer_yolov12_v5",
        "output_filename_prefix": "detections"
    },
...
def main():
    ...
    default_image_ids_json_path = os.path.join(script_dir, "../../data/CADOT_Dataset/valid/_annotations.coco.json")
    ...
    for config_item in CONFIGURATIONS:
        ...
        # Nếu nó chỉ là tên file (ví dụ "../../data/CADOT_Dataset/valid/_annotations.coco.json"), giả sử nó nằm cùng thư mục script
