...
# --- Cấu hình chung ---
DATASET_YAML_PATH = 'Cadot_detect_object_v3.yaml'
# THAY ĐỔI CHÍNH Ở ĐÂY:
BASE_MODEL_NAME = 'yolo12l.pt' # Giả sử tên model mới là yolov11n.pt
# Các lựa chọn có thể là: yolov11n.pt, yolov11s.pt, yolov11m.pt, yolov11l.pt, yolov11x.pt (nếu tồn tại)
PROJECT_NAME = 'CADOT_YOLOv12_v3' # Có thể đổi tên dự án để phân biệt
EXPERIMENT_NAME_TRAIN = 'train_yolov12_01' # Tên cụ thể cho lần huấn luyện này
EXPERIMENT_NAME_VAL = 'val_after_yolov12_train_01'
EXPERIMENT_NAME_PREDICT = 'predict_yolov12_run_01'
...
if __name__ == '__main__':
    ...
    # 2. TIẾP TỤC HUẤN LUYỆN (nếu cần)
    # CHECKPOINT_TO_RESUME = 'runs/detect/CADOT_YOLOv11/train_yolov11_01/weights/last.pt'
    # if CHECKPOINT_TO_RESUME and os.path.exists(CHECKPOINT_TO_RESUME):
    #     best_pt_path_resumed = resume_training(CHECKPOINT_TO_RESUME)
    #     if best_pt_path_resumed and os.path.exists(best_pt_path_resumed):
    #         TRAINED_MODEL_PATH = best_pt_path_resumed
    # else:
    #     print(f"Checkpoint '{CHECKPOINT_TO_RESUME}' không tồn tại. Bỏ qua resume training.")
